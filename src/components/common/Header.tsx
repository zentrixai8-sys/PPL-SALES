...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 px-3.5 sm:px-4 md:px-6 flex items-center justify-between text-slate-800 dark:text-slate-100 transition-colors shadow-xs">
      ...
      <div className="flex items-center gap-2 md:gap-3.5 min-w-0">
        ...
        <div className="flex lg:hidden items-center gap-2.5 min-w-0">
          ...
          <span className="text-sm font-bold text-slate-900 dark:text-white tracking-tight truncate max-w-[130px] sm:max-w-[180px]">
